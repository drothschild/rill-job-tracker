    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="text-center">
          <div class="text-4xl font-bold text-blue-600 mb-2">${metrics.total}</div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="text-center">
          <div class="text-4xl font-bold text-green-600 mb-2">${metrics.response_rate}%</div>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="text-center">
          <div class="text-4xl font-bold text-purple-600 mb-2">${metrics.interview_rate}%</div>
          <div class="text-gray-600 text-sm">Interview Conversion</div>
        </div>
      </div>
    </div>
  `;
...
function renderChartsSection(
  ...
  return `
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      ...
      <!-- Stage Funnel Chart -->
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Stage Funnel</h3>
        <div style="position: relative; height: 300px;">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Warm vs Cold Breakdown</h3>
        <div style="position: relative; height: 300px;">
...
function renderActionableItems(
  ...
  html += `
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h3 class="text-lg font-semibold text-gray-900 mb-4">Overdue Follow-ups</h3>
  `;

  if (overdueFollowUps.length === 0) {
    html += '<p class="text-gray-600 text-center py-4">No overdue follow-ups</p>';
  } else {
    ...
    overdueFollowUps.forEach(item => {
      ...
      html += `
        <li class="border-l-4 border-red-500 pl-3 py-1">
          <a href="/jobs/${item.job.id}" class="text-blue-600 hover:text-blue-800 font-medium">
  ...
  html += `
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h3 class="text-lg font-semibold text-gray-900 mb-4">Stale Applications</h3>
  `;

  if (staleJobs.length === 0) {
    html += '<p class="text-gray-600 text-center py-4">No stale applications</p>';
  } else {
    html += '<ul class="space-y-3">';
